window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const WORKSPACE_MODE_CHOICES = ["auto", "manual"];
		/** Workspace-name placement choices in display order (the card's select). */
		const WORKSPACE_POSITION_CHOICES = [
			"left",
			"right",
			"below"
		];
		...
		*/
		...
		const css$3 = ".aY1d8q_badge{pointer-events:none;user-select:none;z-index:30;box-sizing:border-box;letter-spacing:.01em;max-width:min(60vw,480px);font-weight:600;line-height:1.3;font-family:var(--dsw-alias-font-family,inherit);text-shadow:0 1px 2px #00000059;border-radius:8px;align-items:center;gap:8px;padding:4px 10px;display:flex;position:fixed;top:8px;overflow:hidden;box-shadow:0 1px 3px #0000002e}.aY1d8q_title{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.aY1d8q_workspace{white-space:nowrap;flex:none;font-weight:500}.aY1d8q_badge[data-workspace-position=left]{flex-direction:row-reverse}.aY1d8q_badge[data-workspace-position=below]{flex-direction:column;align-items:flex-start;gap:2px}.aY1d8q_badge[data-position=above-new-session]{max-width:200px;left:12px}.aY1d8q_badge[data-position=top-right]{right:12px}.aY1d8q_badge[data-position=top-left]{left:12px}.aY1d8q_badge[data-position=top-center]{left:50%;transform:translate(-50%)}[data-sidebar-collapsed] .aY1d8q_badge[data-position=above-new-session]{display:none}";
		...
		var title_module_css_default = {
			"badge": "aY1d8q_badge",
			"title": "aY1d8q_title",
			"workspace": "aY1d8q_workspace"
		};
		//#endregion
		...
		*/
		function currentWorkspaceTitle(sessions, workspaces) {
			...
			if (currentId !== void 0) {
				...
				if (owner !== void 0) return owner.title;
				const cwd = sessions.byId[currentId]?.cwd;
				if (cwd !== void 0 && cwd !== "") return (0, _deepseek_ai_dsh_client_runtime_client.workspaceTitleOf)(cwd);
			}
			const recentId = workspaces.recentWorkspaceId;
			if (recentId !== void 0) {
				const recent = workspaces.items.find((workspace) => workspace.workspaceId === recentId);
				if (recent !== void 0) return recent.title;
			}
			return "";
		}
		/**
		...
		*/
		function TitleBadge(props) {
			...
			const workspaceText = settings.workspaceMode === "auto" ? currentWorkspaceTitle(sessions, workspaces) : settings.workspaceText.trim();
			const showWorkspace = settings.workspaceEnabled && workspaceText !== "";
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: title_module_css_default.badge,
				"data-position": settings.position,
				"data-workspace-position": showWorkspace ? settings.workspacePosition : void 0,
				style: {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: title_module_css_default.title,
					style: { fontSize: `${settings.fontSize}px` },
					children: settings.text
				}), showWorkspace ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					className: title_module_css_default.workspace,
					style: { fontSize: `${settings.workspaceFontSize}px` },
					children: [
						"[",
						workspaceText,
						"]"
		...
		var TitleSettingsCardController = class {
			...
			constructor(scope) {
				this.form = new CardForm(scope, [
					...
					boundedNumberField("workspaceFontSize", 10, 72),
		...
		*/
		function TitleSettingsCard(props) {
			...
			const workspacePositionChoices = WORKSPACE_POSITION_CHOICES.map((position) => ({
				value: position,
				label: t(WORKSPACE_POSITION_LABEL_KEYS[position])
			}));
			const workspaceModeChoices = WORKSPACE_MODE_CHOICES.map((mode) => ({
				value: mode,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(PluginSettingsCard, {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(BooleanField, {
						...
						onEdit: (text) => {
							props.edit("workspaceEnabled", text);
						},
						onReset: () => {
							props.resetField("workspaceEnabled");
						}
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChoiceField, {
						...
						onEdit: (text) => {
							props.edit("workspaceMode", text);
						},
						onReset: () => {
							props.resetField("workspaceMode");
						}
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ValueField, {
						...
						...state.workspaceText,
						onEdit: (text) => {
							props.edit("workspaceText", text);
						},
						onReset: () => {
							props.resetField("workspaceText");
						}
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ValueField, {
						...
						onEdit: (text) => {
							props.edit("workspaceFontSize", text);
						},
						onReset: () => {
							props.resetField("workspaceFontSize");
						}
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChoiceField, {
						...
						onEdit: (text) => {
							props.edit("workspacePosition", text);
						},
						onReset: () => {
							props.resetField("workspacePosition");
						}
					})
				]
			});
