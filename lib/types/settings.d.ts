...
export declare const POSITION_DEFAULT: TitlePosition;
/** Default text color (readable on the dark sidebar fill). */
export declare const COLOR_DEFAULT = "#f0f0f0";
/**
 ...
 */
export declare const BACKGROUND_COLOR_DEFAULT = "var(--dsw-alias-bg-layer-3)";
